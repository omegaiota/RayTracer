 ...
 */
        ...
        private:
            ...
            BVHNode *recursiveBuild(size_t start, size_t end, size_t &totalNodesBuild,
                                    std::vector<Primitive *> &orderedPrimitives,
                                    const std::vector<Primitive *> &originalPrimitives,
                                    size_t max_leaf_size); ///< helper function for recursively building BVH
            void traverse(const Ray &ray, BVHNode* currentNode, Intersection *isect, bool &hits) const;
