...
namespace PROJ6850 {
    ...
    string Application::name() { return "raytracer6850"; }
 ...
 */
    ...
    void Application::executeFileOp(int codepoint) {
      ...
      filename << "raytracer6850_buffer" << index << ".dae";
    ...
    void PROJ6850::Application::writeSkeleton(const char *filename,
    ...
    void PROJ6850::Application::loadSkeleton(const char *filename,
