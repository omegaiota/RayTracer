...
void PROJ6850::DynamicScene::XFormWidget::enterJointMode(bool isRoot) {
  jointMode = true;
  jointIsRoot = isRoot;
}

void PROJ6850::DynamicScene::XFormWidget::exitJointMode() { jointMode = false; }
...
//  printf("XFormWidget::updateGeometry()\n");
  if (target.object == nullptr) return;
