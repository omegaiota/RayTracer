#ifndef PROJ6850_DYNAMICSCENE_MESH_H
#define PROJ6850_DYNAMICSCENE_MESH_H
...
class Mesh : public SceneObject {
 ...
 private:
  // Helpers for draw().
    Vector3D closestPoint(Vector3D A, Vector3D B, Vector3D P);
...
#endif  // PROJ6850_DYNAMICSCENE_MESH_H
