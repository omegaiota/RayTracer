#ifndef PROJ6850_STATICSCENE_SPHERE_H
#define PROJ6850_STATICSCENE_SPHERE_H
...
class Sphere : public Primitive {
 ...
 private:
  ...
  bool test(const Ray& ray, double& t1, double& t2) const;
    bool isBetween(double testNum, double min, double max) const;
...
#endif  // PROJ6850_STATICSCENE_SPHERE_H
