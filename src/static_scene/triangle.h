#ifndef PROJ6850_STATICSCENE_TRIANGLE_H
#define PROJ6850_STATICSCENE_TRIANGLE_H
...
class Triangle : public Primitive {
 ...
 private:
  ...
  vector<size_t> v;
  bool getIntersectInfo(const Ray &r, double &u_times_area, double &v_times_area, double &t_times_ara) const;
...
#endif  // PROJ6850_STATICSCENE_TRIANGLE_H
